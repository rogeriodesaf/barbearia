...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-secondary">Novo Pedido</a>
		...
		<div class="modal-body">
			...
			<form method="post">
						...
						<div class="row">
							...
							<input type="valor" class="form-control" id="valor" placeholder="Valor " name="valor" required>
						</div>
							</div>
						</div>
