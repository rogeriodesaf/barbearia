...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-secondary">Novo Fornecedor</a>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><?php if(@$_GET['funcao'] == 'editar'){
					...
					$res = $pdo->query("select * from fornecedores where id = '$id_reg'");
					$dados = $res->fetchAll(PDO::FETCH_ASSOC);
					$nome = $dados[0]['nome'];
					$telefone = $dados[0]['telefone'];
					$email = $dados[0]['email'];
					$remedios = $dados[0]['remedios'];
					
					


					echo 'Edição de fornecedores';
				}else{
					$nome_botao = 'Salvar';
		...
		<div class="modal-body">
			...
			<form method="post">
						...
						<div class="form-group">
							...
							<input type="hidden" id="campo_antigo"  name="campo_antigo" value="<?php echo @$telefone ?>" required>
						...
						<div class="form-group">
							<label for="exampleFormControlInput1">Remédios</label>
							<textarea class="form-control" name="remedios" id="remedios" maxlength="350"><?php echo @$remedios ?></textarea>
						</div>
