<?php $pagina = 'tesoureiros'; ?>

<div class="row botao-novo">
	<div class="col-md-12">
		
		<a id="btn-novo" data-toggle="modal" data-target="#modal"></a>
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-secondary">Novo Tesoureiro</a>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><?php if(@$_GET['funcao'] == 'editar'){
					...
					$res = $pdo->query("select * from tesoureiros where id = '$id_reg'");
					...
					echo 'Edição de Tesoureiro';
				}else{
					$nome_botao = 'Salvar';
					echo 'Cadastro de Tesoureiro';
				} ?>
			</h5>
		...
		<div class="modal-body">
			...
			<form method="post">
					...
					<select class="form-control" id="" name="turno">
						...
						<?php if($turno != 'Noite') echo '<option value="Tarde">Noite</option>'; ?>
